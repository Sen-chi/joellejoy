...
namespace EugenioJoelleJoy_Act_GUI
{
    public partial class EditForm : Form
    {
        ...
        private UserProfile GetUserProfile()
        {
            ...
            {
                Name = "Jolle Joy M. Eugenio",
                Age = 20,
                Address = "456 Cat Street",
                ContactNumber = "090987654321",
                Email = "email@sample.co",
                Course = "BSIT",
                Year = "Third",
                ParentName = "Richelle Eugenio",
                ParentContact = "09123456789",
                Hobbies = "watching anime, reading manga/hwa/hua, playing games",
                Nickname = "Senri"
            };
        }
